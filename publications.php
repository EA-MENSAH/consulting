...
<body class="index-page">
  ...
  <main class="main">
   ...
   <div class="container py-5">
    <h2 class="text-center mb-4" data-aos="fade-down">Our Publications</h2>
      ...
      <?php
        ...
        foreach ($files as $file) {
          ...
          if (strtolower($ext) == 'pdf') {
            ...
            echo '
              <div class="list-group-item pub-item d-flex justify-content-between align-items-center" data-aos="fade-up">
                <div class="pub-title">'.htmlspecialchars($title).'</div>
                <a href="'.$dir.$file.'" class="btn btn-sm btn-primary" target="_blank">View / Download</a>
              </div>
            ';
          }
        }
