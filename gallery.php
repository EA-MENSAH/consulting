...
<body class="index-page">
 ...
 <div class="container py-5">
    <h2 class="text-center mb-4" data-aos="fade-down">Our Gallery</h2>
    <div class="row">
      <?php
        $dir = "assets/gallery/";
        ...
        foreach ($images as $img) {
          ...
          if (in_array(strtolower($ext), ['jpg', 'jpeg', 'png'])) {
            echo '
              <div class="col-md-4 gallery-card" data-aos="zoom-in">
                <img src="'.$dir.$img.'" alt="Gallery Image" class="gallery-img"/>
              </div>
            ';
          }
        }
